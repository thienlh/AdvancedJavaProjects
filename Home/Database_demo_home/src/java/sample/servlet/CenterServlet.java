...
public class CenterServlet extends HttpServlet {
    ...
    private final String loginSevlet = "LoginServlet";
    ...
    private final String addBookServlet = "AddBookServlet";
    private final String removeBookServlet = "RemoveBookServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CenterServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>CenterServlet</h1>");
            ...
            if (button == null) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher(loginSevlet);
                rd.forward(request, response);
                ...
                RequestDispatcher rd = request.getRequestDispatcher(removeBookServlet);
                rd.forward(request, response);
